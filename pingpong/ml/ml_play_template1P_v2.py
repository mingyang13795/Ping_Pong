...
def ml_loop(side: str):
    ...
    while True:
        ...
        if(len(ball_center_record))==1:
            ...
            ball_position_pridictonplatform = ball_center_record[-1][0] +(420-ball_center_record[-1][1])*vx/vy
            while ball_position_pridictonplatform < 0 or ball_position_pridictonplatform > 200:
                ...
                pass
            if platform_center_1p < ball_position_pridictonplatform:
                comm.send_instruction(scene_info.frame, PlatformAction.MOVE_RIGHT)
            elif platform_center_1p > ball_position_pridictonplatform:
            ...
            if platform_center_1p < 100:
                comm.send_instruction(scene_info.frame, PlatformAction.MOVE_RIGHT)
            elif platform_center_1p > 100:
                comm.send_instruction(scene_info.frame, PlatformAction.MOVE_LEFT)
            else:
                continue
