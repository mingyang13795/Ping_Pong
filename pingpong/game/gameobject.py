...
class Ball(pygame.sprite.Sprite):
    def __init__(self, play_area_rect: pygame.Rect, *groups):
        ...
        self._speed = [7, 7]
        self._size = [5, 5]
        service_random = random.randint(0,1)
        if service_random == 0:
            self._serve_from_1P = True
        else:
            self._serve_from_1P = False
            pass
    ...
    def reset(self):
        ...
        if self._serve_from_1P:
            reset_pos_x = random.randint(0,195)
            reset_pos_y = int(self._play_area_rect.height * 0.8 - self.rect.height)
            service_1p_right_random = random.randint(0,1)
            if service_1p_right_random == 0:
                self._speed = [-7, -7]
            else:
                self._speed = [7, -7]
                pass
            ...
            service_2p_right_random = random.randint(0,1)
            if service_2p_right_random == 0:
                self._speed = [-7, 7]
            else:
                self._speed = [7, 7]
                pass
